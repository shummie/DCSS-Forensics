...
build_exe_options = {"silent": ["s"], "create_shared_zip" : False, 
                     "include_files":["config.ini", "style.css", "LICENSE", "README.md", "Version History"]}
...
# Personal note: "C:\program files (x86)\python\python" setup.py build